...
#ifndef TH1520_VDEC_VP9_PROBS_H_
#define TH1520_VDEC_VP9_PROBS_H_

#include <linux/types.h>

struct th1520_vp9_mv_probs {
	u8 joint[3];
	u8 sign[2];
	u8 class0_bit[2][1];
	u8 fr[2][3];
...
struct th1520_vp9_all_probs {
	...
	struct th1520_vp9_probs probs;
};

struct th1520_vp9_mv_counts {
	u32 joints[4];
	u32 sign[2][2];
	u32 classes[2][11];
	u32 class0[2][2];
...
struct th1520_vp9_counts {
	...
	struct th1520_vp9_mv_counts mv_counts;
